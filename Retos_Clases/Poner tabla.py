...
usuarios = {
    ...
    "5": {
        ...
        "preferencias": {
            "idioma": "Inglés",
            "newsletter": False,
            "temas_interes": ["moda", "arte", "cocina" , "Direccion", "Calle"]
        }
    }
}
...
for usuario in usuarios.values():
    contacto = f"{usuario['contacto']['correo']}\n{usuario['contacto']['telefono']}"
    direccion = f"{usuario['calle']['ciudad']['estado']['codigo_postal']['pais'], usuario['calle']['ciudad']['estado']['codigo_postal']['pais'], usuario['calle']['ciudad']['estado']['codigo_postal']['pais'], usuario['calle']['ciudad']['estado']['codigo_postal']['pais'], usuario['calle']['ciudad']['estado']['codigo_postal']['pais']}"
    fila = [
...
encabezados = ["Nombre Completo", "Contacto (Correo / Teléfono)","Direccion"]
